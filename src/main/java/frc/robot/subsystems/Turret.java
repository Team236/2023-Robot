...
public class Turret extends SubsystemBase {
  ...
  public Turret() {
    ...
    turretBrake = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, TurretConstants.TURRET_BRAKE_FOR,
        TurretConstants.TURRET_BRAKE_REV);
  ...
  public double getTurretAngle() {
    // could also use turretEncoder.getDistance() here, since dist per pulse is
    // provided at top of this subystem
  ...
  public void setTurretSpeed(double speed) {
    ...
    if ((speed > 0) && isCWLimit()) {
      ...
      // not a limit going CCW, and not past 300 degrees going CW, go at commanded
      // speed
