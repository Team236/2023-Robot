...
public final class Constants {
  ...
  public static class MotorControllers {
    ...
    public static final int ID_LEFT_FRONT = 10; //10 - 30
    public static final int ID_RIGHT_FRONT = 15; //15 - 43
    public static final int ID_LEFT_REAR = 11; // 11 - 44
    public static final int ID_RIGHT_REAR = 16;//16 - 45
